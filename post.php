 ...
 if(isset($_POST['submit1']))
  {
      ...
      if($var>0)
      {
            ...
            echo "<script>window.open('Welcome.php#1','_self')</script>";
      }
      else
      {
            echo "not submitted";
 ...
 if(isset($_POST['submit2']))
  {
      ...
      if($var>0)
      {
            ...
            echo "<script>window.open('Welcome.php#2','_self')</script>";
      }
      else
      {
            echo "not submitted";
 ...
 if(isset($_POST['submit3']))
  {
      ...
      if($var>0)
      {
            ...
            echo "<script>window.open('Welcome.php#3','_self')</script>";
      }
      else
      {
            echo "not submitted";
